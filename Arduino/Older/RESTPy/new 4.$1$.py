...
4 Spectrum Virtualize: RESTful API
...
if show:
Chapter 1. Overview of the RESTful API 5
...
6 Spectrum Virtualize: RESTful API
)
...
"""
Comment: First, set your cluster ipaddress. It’s assumed superuser/passw0rd (6 lines above) is the crednetial.
After the authenticate call, you can issue any command in s.command(’’) that is an svcinfo or svctask cmmand)
"""
